...
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v3.1/Services/moonraker -P /etc/init.d/
chmod 755 /etc/init.d/moonraker
/etc/init.d/moonraker enable
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v3.1/nginx/upstreams.conf -P /etc/nginx/conf.d/
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v3.1/nginx/common_vars.conf -P /etc/nginx/conf.d/
