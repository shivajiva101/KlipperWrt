...
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/Services/klipper -P /etc/init.d/;
...
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/Services/moonraker -P /etc/init.d/
chmod 755 /etc/init.d/moonraker
/etc/init.d/moonraker enable
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/nginx/upstreams.conf -P /etc/nginx/conf.d/
wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/nginx/common_vars.conf -P /etc/nginx/conf.d/
...
choose(){
	...
	while true; do
    	...
    	echo "You chose Fluidd"
		  ...
		  wget -O /root/printer_data/config/moonraker.conf https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/moonraker/fluidd_moonraker.conf;
		  wget -O /etc/nginx/conf.d/fluidd.conf https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/nginx/fluidd.conf;
			wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/klipper_config/fluidd.cfg -P /root/printer_data/config/
	    echo "   ***************************"
			echo "   **         Done!         **"
			echo "   ***************************"
			echo " "
		...
		2)
			...
			wget -O /root/printer_data/config/moonraker.conf https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/moonraker/mainsail_moonraker.conf;
			wget -O /etc/nginx/conf.d/mainsail.conf https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/nginx/mainsail.conf;
			wget https://raw.githubusercontent.com/shivajiva101/KlipperWrt/v4.0/klipper_config/mainsail.cfg -P /root/printer_data/config/
			echo "   ***************************"
			echo "   **         Done          **"
			echo "   ***************************"
			echo " "
